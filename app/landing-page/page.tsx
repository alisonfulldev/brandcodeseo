...
export const metadata: Metadata = buildMetadata({
  title: "Criação de Landing Page Profissional que Converte | Taxa de Implementação R$ 199",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-[#0A1628] rounded-2xl p-8 text-white">
              ...
              <div className="text-5xl font-extrabold text-white mt-3 mb-1">R$ 199</div>
              <p className="text-gray-400 text-sm mb-7">taxa de implementação única</p>
