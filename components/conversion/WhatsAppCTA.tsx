...
const COPY: Record<"A" | "B" | "C", string> = {
  A: "Quero meu site agora →",
  B: "Solicitar orçamento grátis →",
  C: "Falar com especialista →",
};
...
const DEFAULT_MESSAGE = "Olá! Quero um orçamento para o meu site.";
